...
$pageTitle = (string) ($storyMeta['folder_title'] ?? 'Impact Story');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <?php if ($storyMeta): ?>
    <meta name="description" content="<?= e((string) ($storyMeta['summary'] ?? '')) ?>">
    <?php endif; ?>
...
<main class="container page-main page-main-compact impact-main">
    ...
    <header class="impact-hero">
        ...
        <p class="impact-hero-lead">
            ...
            >1</strong>
            children at Dzaleka Refugee Camp participated in a SciFables science session with the Art for Hope team.
        </p>
    </header>
