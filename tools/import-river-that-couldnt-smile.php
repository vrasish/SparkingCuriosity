...
/**
 * Import "The River That Couldn't Smile" into Earth Science (not on homepage).
 *
 *   php tools/import-river-that-couldnt-smile.php
 *   php tools/import-river-that-couldnt-smile.php --source="/path/to/file.pdf"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_River_That_Couldnt_Smile_Plastic_Pollution_Storybook (1).pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = "The River That Couldn't Smile";
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Earth Science';
$storyTopic = 'Plastic pollution';
$description = 'Maya and Leo visit Grandpa Arun’s riverside village and find their once-sparkling river choked with plastic. As they clean up and learn how litter harms wildlife, they discover plastic pollution often starts on land—and that people can help protect rivers and animals.';
$scienceElement = 'Plastic is useful because it is strong and lasts a long time, but plastic thrown into nature does not disappear. Many plastic items take hundreds of years to break down and slowly become tiny pieces called microplastics that can enter rivers, oceans, animals, and even our food. Animals may eat plastic by mistake or become trapped in it. We can help by recycling, using reusable bottles and bags, never littering, joining cleanups, and picking up litter.';
...
$coverFilename = 'cover_the_river_that_couldnt_smile.png';
