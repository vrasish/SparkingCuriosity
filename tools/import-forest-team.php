...
/**
 * Import "The Forest Team" into Plants (not on homepage).
 *
 *   php tools/import-forest-team.php
 *   php tools/import-forest-team.php --source="/path/to/file.pdf" --cover="/path/to/cover.png"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_Forest_Team_Biotic_and_Abiotic_Factors_Storybook (1).pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = 'The Forest Team';
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Plants';
$storyTopic = 'Biotic & Abiotic Factors';
$description = 'In a lively forest, two curious kids discover how living things and nonliving things work as a team—and learn why sunlight, water, soil, plants, and animals all matter in an ecosystem.';
$scienceElement = 'Biotic factors are the living parts of an ecosystem, like plants, animals, fungi, and microbes. Abiotic factors are the nonliving parts, like sunlight, water, air, soil, and temperature. Living and nonliving things work together. Plants need sunlight and water to grow, animals need plants for food and shelter, and the whole forest community depends on both biotic and abiotic factors.';
...
$coverFilename = 'cover_the_forest_team.png';
