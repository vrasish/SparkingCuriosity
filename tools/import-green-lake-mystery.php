...
/**
 * Import "The Green Lake Mystery" into Microbes (not on homepage).
 *
 *   php tools/import-green-lake-mystery.php
 *   php tools/import-green-lake-mystery.php --source="/path/to/file.pdf" --cover="/path/to/cover.png"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_Green_Lake_Mystery_Algae_and_Algal_Blooms_Storybook.pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = 'The Green Lake Mystery';
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Microbes';
$storyTopic = 'Algae & Algal Blooms';
$description = 'When a neighborhood pond turns bright green, two curious kids and Grandma June discover tiny algae, what causes algal blooms, and why too much algae can harm lake life.';
$scienceElement = 'Algae are tiny plant-like organisms that live in water and use sunlight to grow. When algae multiply quickly, they can form an algal bloom that turns water green. Blooms often happen when extra nutrients enter the water. Too much algae can block sunlight and use up oxygen, making it hard for fish and other lake life to survive.';
...
$coverFilename = 'cover_the_green_lake_mystery.png';
