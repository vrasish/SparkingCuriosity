...
/**
 * Import "The Treasure That Never Runs Out" into Earth Science (not on homepage).
 *
 *   php tools/import-treasure-that-never-runs-out.php
 *   php tools/import-treasure-that-never-runs-out.php --source="/path/to/file.pdf" --cover="/path/to/cover.png"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_Treasure_That_Never_Runs_Out_A4_Cream_Clear_Larger_Font.pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = 'The Treasure That Never Runs Out';
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Earth Science';
$storyTopic = 'Natural Resources (Renewable & Non-renewable)';
$description = 'On Outdoor Learning Day, Lila and Jay follow Ranger Maya’s treasure map through Green Valley Nature Park. Along rivers, hills, fields, and forests, they discover that Earth’s real treasures are natural resources—and learn which ones can renew and which ones we must use wisely.';
$scienceElement = 'Natural resources are the things we get from nature that we need to live and grow, including food, water, air, and energy. Renewable resources, such as sunlight, water, wind, and trees, can be replaced naturally in a short time if we use them wisely. Non-renewable resources, such as coal, oil, natural gas, and metals, take millions of years to form and cannot be replaced in our lifetime. Coal, oil, and natural gas are fossil fuels formed from ancient plants and animals. We can help by saving water and energy, planting trees, and reducing, reusing, and recycling.';
...
$coverFilename = 'cover_the_treasure_that_never_runs_out.png';
