...
/**
 * Import "The Forest Mystery" into Plants (not on homepage).
 *
 *   php tools/import-forest-mystery.php
 *   php tools/import-forest-mystery.php --source="/path/to/file.pdf" --cover="/path/to/cover.png"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_Forest_Mystery_Storybook.pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = 'The Forest Mystery';
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Plants';
$storyTopic = 'Producers, Consumers, and Decomposers';
$description = 'On a sunlit forest trail, two curious kids and Dr. Kim discover fallen leaves, mushrooms, and living trees—and learn how producers, consumers, and decomposers work together in a forest ecosystem.';
$scienceElement = 'Producers, like plants and trees, make their own food through photosynthesis. Consumers are animals that eat plants or other animals for energy. Decomposers, such as fungi and bacteria, break down dead leaves and logs, returning nutrients to the soil so new plants can grow.';
...
$coverFilename = 'cover_the_forest_mystery.png';
