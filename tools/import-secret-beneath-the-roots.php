...
/**
 * Import "The Secret Beneath the Roots" into Microbes (not on homepage).
 *
 *   php tools/import-secret-beneath-the-roots.php
 *   php tools/import-secret-beneath-the-roots.php --source="/path/to/file.pdf" --cover="/path/to/cover.png"
 */
...
$sourcePdf = isset($options['source'])
    ...
    : (getenv('HOME') . '/Downloads/The_Secret_Beneath_the_Roots_Nitrogen_Fixation_Corrected.pdf');
$coverSource = isset($options['cover'])
    ? (string) $options['cover']
    : '';

$title = 'The Secret Beneath the Roots';
$author = 'Vaishnavi Renduchintala';
$categoryName = 'Microbes';
$storyTopic = 'Nitrogen fixation';
$description = 'In Grandma Rosa\'s sunny garden, two curious kids pull up a bean plant and discover tiny bumps on its roots—and learn how special bacteria help plants capture nitrogen from the air.';
$scienceElement = 'Some plants, like beans and peas, work with helpful bacteria that live in bumps called nodules on their roots. These bacteria turn nitrogen gas from the air into a form plants can use. This process is called nitrogen fixation. It helps plants grow strong and returns nitrogen to the soil for other plants.';
...
$coverFilename = 'cover_the_secret_beneath_the_roots.png';
