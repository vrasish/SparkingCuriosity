...
<main class="container page-main page-main-compact">
    <?php render_page_header('Create Account', 'Enter your name, email, and password to get started.'); ?>
    ...
    <div class="page-section">
        ...
        <div class="form-panel login-panel">
            ...
            <p class="mt-2">Already have an account? <a href="<?= e(app_url('login.php?redirect=' . rawurlencode($redirect))) ?>">Log in with email and password</a></p>
        </div>
    </div>
</main>
